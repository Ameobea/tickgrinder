...
g++ -g -rdynamic -shared -fPIC -std=c++11 -O0 src/libfxcm_ffi.cpp src/broker_server.cpp src/GlobalResponseListener.cpp \
...
-Wl,--no-undefined -o dist/libfxcm_ffi.so src/GlobalTableListener.cpp src/SessionStatusListener.cpp \
...
dist/libForexConnect.so dist/libfxmsg.so \
