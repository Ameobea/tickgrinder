...
g++ -shared -fPIC src/libfxcm_ffi.cpp src/broker_server.cpp src/libfxcm_ffi.h \
...
-I boost_1_49_0/boost -Iinclude/ForexConnectAPI-Linux-x86_64/samples/cpp/NonTableManagerSamples/GetHistPrices/source/ \
